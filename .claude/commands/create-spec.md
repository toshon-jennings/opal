---
description: Interview the user and generate an AutoForge app spec for a project directory
...
This command **requires** the project directory as an argument via `$1`.

**Example:** `/create-spec generations/my-app`

**Output location:** `$1/.autoforge/prompts/app_spec.txt` and `$1/.autoforge/prompts/initializer_prompt.md`

If `$1` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `$1/.autoforge/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `$1/.autoforge/prompts/app_spec.txt`
...
**Output path:** `$1/.autoforge/prompts/initializer_prompt.md`
...
**Output path:** `$1/.autoforge/prompts/.spec_status.json`
...
> "Your specification files have been created in `$1/.autoforge/prompts/`!
>
> **Files created:**
> - `$1/.autoforge/prompts/app_spec.txt`
> - `$1/.autoforge/prompts/initializer_prompt.md`
>
